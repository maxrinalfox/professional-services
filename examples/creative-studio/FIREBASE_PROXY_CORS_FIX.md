...
```
https://cstudio-backend-development-600251015884.us-central1.run.app
```

Instead of the **Firebase Hosting proxy URL**:
```
https://foxsports-prod-ops-sandbox.web.app
```
...
1. **Frontend Application** (`environment.prod.ts`)
   ...
   - Calls: `https://foxsports-prod-ops-sandbox.web.app/api/*`
...
1. **environment.prod.ts** (Angular frontend configuration)
   ...
   ```
   Result: `backendURL: 'https://foxsports-prod-ops-sandbox.web.app/api'`
...
1. Open https://foxsports-prod-ops-sandbox.web.app
2. Press F12 → Network tab
3. Make an API call (login, fetch data, etc.)
4. Check Request URL in Network tab:
   - ✅ Should show: `https://foxsports-prod-ops-sandbox.web.app/api/...`
